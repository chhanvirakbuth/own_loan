...
@section('title')
  ដាក់ប្រាក់សន្សំ - {{$deposit->people->name_kh}}
@endsection
@section('custom-css')
  ...
  <div class="card-body">
    ...
    <form action="{{route('deposit.save',$account->account_no)}}" method="post" id="submit_form">
      ...
      <div class="input-group">
         ...
         <input type="text" class="form-control save_amount" maxlength="8" name="save_amount"
         placeholder="បញ្ចូលចំនួនប្រាក់សន្សំ" autocomplete="off">
      ...
      <div class="form-group">
        <div class="text-center my-3">
          <button class="btn btn-md btn-light" id="submit" type="submit" ><i class="fa fa-plus"></i> ដាក់សន្សំ <i class="fa fa-plus"></i></button>
        </div>
      </div>
    </form>
