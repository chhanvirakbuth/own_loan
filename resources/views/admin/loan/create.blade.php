...
@section('content')
  <div class="card">
        <div class="card-body">
          ...
          @endif
          {{-- end --}}
          <form id="signupForm" action="{{route('admin.loan.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                ...
                <label for="input-23" class="col-sm-2 col-form-label">ត្រូវបង់ផ្ដាច់ថ្ងៃ</label>
                <div class="col-sm-4">
                    <input type="text" disabled class="form-control" id="input-23" name="close_at">
                </div>
            </div>
